# How the on-prem side verifies and consumes the corpus

This is the contract between `cairn-corpus` and the on-prem system that merges it with internal content.
